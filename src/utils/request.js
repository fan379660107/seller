...
export default function request(url, options, type = '') {
  ...
  if(url.indexOf('sellerLogin/oauth/token')>-1||url.indexOf('sellerLogin/oauth/register')>-1||url.indexOf('msg/seller/commons/smsCode')>-1){
    newOptions.headers.Authorization = 'Basic VVcxS2FsVXlWbk5pUjFaNTpVMjFHTWxsVlFrUmlNMEkxVlcxc2JtRklVa0ZWTW5oMldrYzVkUT09';
  }else{
    newOptions.headers.Authorization = 'Bearer '+getLocalStorageStingVal('sld_token');
  }

	if (newOptions.method === 'POST' || newOptions.method === 'PUT') {
		console.log(JSON.stringify(newOptions.body));
