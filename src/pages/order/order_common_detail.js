...
export default class Order_detail extends Component {
  ...
  render() {
    const {
      order_detail, invoice_info, receiver_info, order_info, return_progress_data, titleName, submiting, show_foot, modal_width, showTopTip, modalVisible, operateData, secondTitle, secondSubmiting, secondModalVisible, secondOperateData, reserve_info,
    } = this.state;
    return (
