        ...
        <div className={global.operate_bg}
          ...
          <div style={{ display: 'flex', flexDirection: 'row' }}>
            ...
            {selectedRowKeys.length == 0 ? sldIconBtn(() => {
              ...
              //确认上架选中的商品吗？
            }, `${sldComLanguage('上架')}`, 7, 0, 13, 13, 3, 'ziyuan25', '#0bac6a') : sldPopConfirm('leftBottom', `${sldComLanguage('确认上架选中的商品吗？')}`, () => this.operateGoods({goodsIds:selectedRowKeys.join(',')}, 'up'), `${sldComLanguage('确定')}`, `${sldComLanguage('取消')}`, sldIconBtn(null, `${sldComLanguage('上架')}`, 7, 0, 13, 13, 3, 'ziyuan25', '#0bac6a'), 0, 0, '#0bac6a')}
