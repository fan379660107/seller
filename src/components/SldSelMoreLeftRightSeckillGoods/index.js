  ...
  get_list = (params) => {
    ...
    dispatch({
      ...
      callback: (res) => {
        ...
        if (res.state == 200) {
          console.log(res.data.pagination.current);
          if (res.data.pagination != undefined) {
            ...
            //    data.list =[{seckillProductVOList:[{
            //     productId:888,
            //     specValues:"红色",
            //     productStock:88,
            //     productPrice:888
            // }],activityState:1,activityDesc:null,goodsName:"lc测试1",goodsPicture:"https://img1.baidu.com/it/u=3690903232,1400294707&fm=253&fmt=auto&app=138&f=JPEG?w=500&h=724",goodsId:"888",goodsPrice:"888",goodsStock:"88"},
            //    {seckillProductVOList:[{
            //     productId:999,
            //     specValues:"橙色",
            //     productStock:99,
            //     productPrice:999
            // }],activityState:2,activityDesc:"已参加其他活动",goodsName:"lc测试2",goodsPicture:"https://img1.baidu.com/it/u=1814112640,3805155152&fm=253&fmt=auto&app=120&f=JPEG?w=889&h=500",goodsId:"999",goodsPrice:"999",goodsStock:"99"},
            //    {seckillProductVOList:[{
            //     productId:777,
            //     specValues:"黄色",
            //     productStock:77,
            //     productPrice:777
            // }],activityState:1,activityDesc:null,goodsName:"lc测试3",goodsPicture:"https://img1.baidu.com/it/u=1814112640,3805155152&fm=253&fmt=auto&app=120&f=JPEG?w=889&h=500",goodsId:"777",goodsPrice:"777",goodsStock:"77"},
            //    {seckillProductVOList:[{
            //     productId:666,
            //     specValues:"绿色",
            //     productStock:66,
            //     productPrice:666
            // }],activityState:2,activityDesc:"已参加其他活动",goodsName:"lc测试4",goodsPicture:"https://img1.baidu.com/it/u=1814112640,3805155152&fm=253&fmt=auto&app=120&f=JPEG?w=889&h=500",goodsId:"666",goodsPrice:"666",goodsStock:"66"},
            //    {seckillProductVOList:[{
            //     productId:555,
            //     specValues:"蓝色",
            //     productStock:55,
            //     productPrice:555
            // }],activityState:1,activityDesc:null,goodsName:"lc测试5",goodsPicture:"https://img1.baidu.com/it/u=2241334221,3271234001&fm=253&fmt=auto&app=138&f=JPEG?w=800&h=500",goodsId:"555",goodsPrice:"555",goodsStock:"55"}
            //   ];
            } else {
